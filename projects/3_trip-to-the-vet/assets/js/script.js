...
const navigatorDisplay = document.getElementById("navigatorDisplay");
...
document.addEventListener("keydown", (event) => {
    ...
    if (isOverlapping(character, rm1)) {
        imageToShow = "assets/images/map2.png";
    }
    else if (isOverlapping(character, rm2)) {
        imageToShow = "assets/images/map3.png";
    }
    else if (isOverlapping(character, rm3)) {
        imageToShow = "assets/images/map4.png";
    }
    else if (isOverlapping(character, rm4)) {
        imageToShow = "assets/images/map5.png";
    }
    else if (isOverlapping(character, rm5)) {
        imageToShow = "assets/images/map6.png";
    }
    else if (isOverlapping(character, rm6)) {
        imageToShow = "assets/images/map7.png";
    }
    else if (isOverlapping(character, rm7)) {
        imageToShow = "assets/images/map8.png";
    }
    else if (isOverlapping(character, rm8)) {
        imageToShow = "assets/images/map9.png";
    }
    else if (isOverlapping(character, triggerZone)) {
        imageToShow = "assets/images/map1.png";
    }

    else if (isOverlapping(character, drugs)) {
        imageToShow = "assets/images/map10.png";
    }

    if (!imageToShow) return;

    navigatorPanel.style.display = "flex";
    navigatorDisplay.src = imageToShow;
});
...
document.addEventListener("keydown", (event) => {
    ...
    navigatorPanel.style.display =
        navigatorOpen ? "flex" : "none";
});
