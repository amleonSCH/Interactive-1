const ROOMS = {
  ...
  8: {
    ...
    script:[
      "Cry: It's strange…",
      "Cry: how's it going to feel now that he's gone...",
      "Cry: I won't be able to hear his little steps in the morning anymore",
      "MAKE_CHOICE", 
    ],
    options: {
    ...
    goodEnding: "Cry: ... thank you, but I'm happy I could love him till the end",
    badEnding: "Cry: ...please leave",
  },
};
